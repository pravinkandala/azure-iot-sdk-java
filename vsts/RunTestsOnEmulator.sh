...
#Return code from adb shell can't isn't returned as one would expect. Need to capture output and analyze the output to determine
# if this test run was a success or not
